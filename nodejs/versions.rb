...
commands = ["browserify", "bower", "bundle", "coffee", "express", "gcc", "gem", "grunt", "gulp", "g++", "istanbul", "jake", "less", "mocha", "npm", "node", "nodemon", "node-gyp", "pip", "python", "ruby", "rvm", "sass", "virtualenv"]
script = <<-SHELL
#!/bin/bash
